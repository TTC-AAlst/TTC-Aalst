...
namespace Ttc.DataAccess.Migrations
{
    ...
    [Migration("20260921120000_PlayerNotes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ttc.DataEntities.DivisionRankingWeekEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Year", "Competition", "FrenoyDivisionId", "Week");

                    b.ToTable("DivisionRankingWeek");
                });
            ...
            modelBuilder.Entity("Ttc.DataEntities.PlayerNoteEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("OpponentUniqueIndex")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PlayerId", "Competition", "OpponentUniqueIndex")
                        .IsUnique();
            ...
            modelBuilder.Entity("Ttc.DataEntities.ToogEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ttc.DataEntities.PlayerNoteEntity", b =>
                {
                    ...
                    b.OwnsOne("Ttc.DataEntities.Core.Audit", "Audit", b1 =>
                        {
                            b1.Property<int>("PlayerNoteEntityId")
                                .HasColumnType("int");
                            ...
                            b1.HasKey("PlayerNoteEntityId");

                            b1.ToTable("PlayerNote");

                            b1.WithOwner()
                                .HasForeignKey("PlayerNoteEntityId");
                        });
